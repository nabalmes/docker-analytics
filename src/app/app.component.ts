...
import { locale as langEnglish } from 'app/common/i18n/en';
import { locale as langTagalog } from 'app/common/i18n/tl';
...
export class AppComponent implements OnInit, OnDestroy {
  coreConfig: any;
  menu: any;
  defaultLanguage: 'tl'; // This language will be used as a fallback when a translation isn't found in the current language
  appLanguage: 'tl'; // Set application default language i.e fr
  ...
  constructor(
    ...
    this._translateService.addLangs(['en', 'tl']);

    // This language will be used as a fallback when a translation isn't found in the current language
    this._translateService.setDefaultLang('tl');

    this._translateService.use('tl');

    // Set the translations for the menu
    this._coreTranslationService.translate(langEnglish, langTagalog);
